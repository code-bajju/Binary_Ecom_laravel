                                        ...
                                        <div class="col-sm-6 mt-sm-0 mt-4">
                                            <div class="thumb">
                                                ...
                                                <div class="avatar-edit">
                                                    <input type="file" class="profilePicUpload" id="logoDark" accept=".png, .jpg, .jpeg" name="dark_logo">
                                                    <label for="logoDark" class="bg--primary">@lang('Select Dark Logo') </label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 mt-sm-0 mt-4">
                                            <div class="thumb">
                                                <div class="avatar-preview">
                                                    ...
                                                    <div class="avatar-edit">
                                                        <input type="file" class="profilePicUpload" id="logoLight" accept=".png, .jpg, .jpeg" name="light_logo">
                                                        <label for="logoLight" class="bg--primary">@lang('Select Light Logo') </label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
