                        ...
                        <div class="card-body">
                            <form action="{{route('user.verify.sms')}}" method="POST" class="cmn-form mt-30">
                                ...
                                <div class="form-group d-flex justify-content-between align-items-center">
                                    <p>@lang('Please check including your Junk/Spam Folder. if not found, you can') <a href="{{route('user.send.verify.code')}}?type=sms" class="forget-pass"> @lang('Resend code')</a></p>
